...
//			+ "AND MONTH(sm.effective_date)=MONTH(NOW()) and sd.STOCK_DETAILS_ID = sid.STOCK_DETAILS_ID  AND sm.COMPANY_ID = ? group by YEAR(NOW()),MONTH(NOW())";
	...
	public static final String DB_GET_SALES_DETAILS = "SELECT SALES_ID, CUST_ID, VOUCHER_NUMBER, PARTY_LEDGER_NAME, SALE_DATE, EFFECTIVE_DATE, VCH_TYPE, VOUCHER_KEY, LEDGER_NAME, AMOUNT, CREATED_DATE, MODIFIED_DATE, COMPANY_ID FROM SALES_DETAILS WHERE SALES_ID = ? AND COMPANY_ID = ?";
	...
	public static final String DB_GET_RECEIPT_DETAILS = "SELECT RECEIPT_ID, CUST_ID, VOUCHER_NUMBER, PARTY_LEDGER_NAME, RECEIPT_DATE, EFFECTIVE_DATE, VCH_TYPE, VOUCHER_KEY, LEDGER_NAME, AMOUNT, CREATED_DATE, MODIFIED_DATE, COMPANY_ID FROM RECEIPT_DETAILS WHERE RECEIPT_ID = ? AND COMPANY_ID = ?";
