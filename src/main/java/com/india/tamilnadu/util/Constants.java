...
public class Constants {
	...
	*/
	...
	public static final String DB_GET_SALES_ORDER = "SELECT ID, ORDER_NO, VOUCHER_KEY, COMPANY, ORDER_DATE, BF, GSM, SIZE, WEIGHT, REEL, ORDER_STATUS, ALTERED, COMPANY_ID FROM TALLYDB.SALES_ORDERS WHERE ORDER_STATUS = 0 AND COMPANY_ID = ? ORDER BY ORDER_NO";
	...
	public static final String DB_UPDATE_SALES_ORDER = "update SALES_ORDERS set ORDER_STATUS = 1 where ID = ? and COMPANY_ID = ?";
