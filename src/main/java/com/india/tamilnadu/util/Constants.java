...
public class Constants {
	...
	*/
	...
	public static final String DB_GET_USERS = "SELECT USERS.USER_NAME, USERS.ROLE_ID, USERS.USER_STATUS, USERS.CREATED_DATE, ROLE.ROLE_NAME FROM USERS, ROLE WHERE USERS.ROLE_ID = ROLE.ROLE_ID AND COMPANY_ID = ? ORDER BY USERS.USER_NAME";
	...
	public static final String DB_ADD_USERS = "INSERT INTO USERS(USER_NAME, PWD, COMPANY_ID, ROLE_ID, USER_STATUS, CREATED_DATE, MODIFIED_DATE) VALUES (?,?,?,?,?,?,?)";
	...
	public static final String DB_GET_MESSAGE = "SELECT MESSAGE, URL, CREATED_DATE, ROLE_ID, TITLE FROM MESSAGE WHERE STATUS = 'active' AND COMPANY_ID = ?";
