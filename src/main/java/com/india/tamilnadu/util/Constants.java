...
public class Constants {
	...
	*/
	...
	public static final String DB_GET_USERS = "SELECT USERS.USER_NAME, USERS.ROLE_ID, USERS.USER_STATUS, USERS.CREATED_DATE, ROLE.ROLE_NAME FROM USERS, ROLE WHERE USERS.ROLE_ID = ROLE.ROLE_ID AND COMPANY_ID = ?";
