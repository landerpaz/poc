...
public class Constants {
	...
	*/
	...
	public static final String DB_AUTHENTICATION = "SELECT COMPANY_ID, ROLE_ID FROM USERS WHERE USER_NAME = ? AND PWD = ? AND USER_STATUS =? AND USER_TYPE = ?";
	public static final String DB_GET_USERS = "SELECT USERS.USER_NAME, USERS.ROLE_ID, USERS.USER_STATUS, USERS.CREATED_DATE, ROLE.ROLE_NAME, USERS.FIRST_NAME, USERS.LAST_NAME FROM USERS, ROLE WHERE USERS.ROLE_ID = ROLE.ROLE_ID AND COMPANY_ID = ? AND USER_TYPE = ? ORDER BY USERS.USER_NAME";
	public static final String DB_GET_ALL_USERS = "SELECT USERS.USER_NAME, USERS.ROLE_ID, USERS.USER_STATUS, USERS.CREATED_DATE, ROLE.ROLE_NAME, USERS.FIRST_NAME, USERS.LAST_NAME, USERS.COMPANY_ID FROM USERS, ROLE WHERE USERS.ROLE_ID = ROLE.ROLE_ID ORDER BY USERS.USER_NAME";
	...
	public static final String DB_UPDATE_EXTERNAL_USERS = "UPDATE USERS SET USER_STATUS = ?, MODIFIED_DATE = ? WHERE USER_NAME = ? AND COMPANY_ID = ?";
	public static final String DB_ADD_USERS = "INSERT INTO USERS(USER_NAME, PWD,  COMPANY_ID, ROLE_ID, USER_STATUS, CREATED_DATE, MODIFIED_DATE, FIRST_NAME, LAST_NAME, USER_TYPE) VALUES (?,?,?,?,?,?,?,?,?,?)";
	public static final String DB_ADD_EXTERNAL_USERS = "INSERT INTO EXTERNAL_USERS(CUSTOMER_ID, USER_NAME) VALUES (?,?)";
	...
	public static final String DB_ADD_COMPANY = "INSERT INTO COMPANY (COMPANY_ID, COMPANY_NAME, EMAIL1, EMAIL2, CREATED_DATE) VALUES (?,?,?,?,?)";
	...
	public static final String DB_UPDATE_SALES_ORDERS_PLANNED_REEL_WEIGHT_RIS = "UPDATE SALES_ORDERS_PLANNED SET WEIGHT = ?, REEL = ?, REEL_IN_STOCK = ?  WHERE COMPANY_ID = ? AND SALES_ORDERS_PLANNED_ID = ?";
...
//			+ "AND MONTH(sm.effective_date)=MONTH(NOW()) and sd.STOCK_DETAILS_ID = sid.STOCK_DETAILS_ID  AND sm.COMPANY_ID = ? group by YEAR(NOW()),MONTH(NOW())";
	...
	public static final String DB_GET_COMPANY = "SELECT COMPANY_ID, COMPANY_NAME, CREATED_DATE, CHECK_FLAG, EMAIL1, EMAIL2 FROM COMPANY WHERE COMPANY_ID = ?";
	
	public static final String DB_GET_CUSTOMER = "SELECT CUSTOMER_ID, GST_NO, NAME, CUSTOMER_TYPE, CUSTOMER_GROUP, COMPANY_ID, CREATED_DATE FROM CUSTOMERS WHERE NAME = ? OR GST_NO = ?";
	
	public static final String DB_GET_CUSTOMER_DETAIL = "SELECT CUSTOMER.CUSTOMER_ID, CUSTOMER.NAME FROM CUSTOMERS CUSTOMER, EXTERNAL_USERS EXTERNAL_USER WHERE CUSTOMER.CUSTOMER_ID = EXTERNAL_USER.CUSTOMER_ID AND  EXTERNAL_USER.USER_NAME = ?";

	public static final String DB_GET_CUSTOMER_BALANCE = "SELECT CURRENT_BALANCE FROM CUSTOMERS_BALANCE WHERE CUSTOMER_ID = ? AND COMPANY_ID = ?";
